...
public interface ProductVariantRestMapper {
    ...
    ProductVariantSummariesResponse toResponse(ProductVariant productVariant);

    ProductVariantSummariesResponse toResponseDetails(ProductVariantDetails details);
